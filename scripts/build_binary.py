...
def main(
    ...
    *,
    ...
    #     python idem/scripts/emit_peer_row_view.py --out src/one_link/certified/peer_row.json
    ...
    if not (certified_dir / "peer_row.json").is_file():
        print(
            ...
            "  claims a proven surface. Regenerate it with idem/scripts/emit_peer_row_view.py."
        )
        return 6
