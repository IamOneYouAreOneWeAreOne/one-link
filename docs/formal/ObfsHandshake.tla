...
CONSTANTS
    ...
    MaxNetworkMessages \* finite queue bound for exhaustive checking

ASSUME MaxNetworkMessages \in 1 .. 4
...
Symmetry == Permutations(Bridges) \cup Permutations(Clients)
...
TypeOK ==
    ...
    /\ Len(network) <= MaxNetworkMessages
