...
if HAS_NATIVE:
    ...
    FRAME_FOUNTAIN_BURST: int = _native_quic.FRAME_FOUNTAIN_BURST
    FRAME_FOUNTAIN_ACK: int = _native_quic.FRAME_FOUNTAIN_ACK
    FRAME_FOUNTAIN_REQUEST: int = _native_quic.FRAME_FOUNTAIN_REQUEST
    FRAME_SCOPED_BLOOM_FILTER: int = _native_quic.FRAME_SCOPED_BLOOM_FILTER
    ...
    FRAME_FOUNTAIN_BURST = 0x22
    FRAME_FOUNTAIN_ACK = 0x23
    FRAME_FOUNTAIN_REQUEST = 0x24
    FRAME_SCOPED_BLOOM_FILTER = 0x25
