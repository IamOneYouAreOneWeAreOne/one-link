...
**v0.2.13** — automatic same-computer ghost hiding, no manual cleanup UI, obvious file sending from the Files panel, clearer people-facing labels, activity/folder guidance, and persistent transfer tracking.
